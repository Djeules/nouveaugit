...
## 25. La section 07 retirée — et ce que ça ne règle pas

Julien trouve la page trop longue sur mobile, et demande la suppression de
la section 07 (Modèle, le stylo « open weight » et son tableau de
variantes). Fait : section supprimée, sections suivantes renumérotées
08→07 jusqu'à 12→11, liens de la barre, du menu et du pied de page
retirés, bloc CSS `.model` supprimé (15 lignes devenues mortes).

**Le gain est de 828 px sur 21 605, soit 3,8 %.** La page passe de 25,1 à
24,2 écrans à 490 px de large. Une demande légitime, exécutée, qui ne règle
pas le problème qui la motive.

Les hauteurs mesurées à cette largeur, pour la prochaine fois :
...
Deux enseignements. D'abord, **aucune section isolée ne pèse plus de 9 %** :
il n'existe pas de coupe unique qui raccourcisse la page de façon sensible.
Ensuite, **la moitié réelle pèse 9 385 px contre 12 219 pour la fiction** —
couper dans la fiction pour abréger revient à raboter la démonstration qui
donne son poids à l'aveu.

### Le chiffre de la Divulgation était faux

En comptant les mots pour vérifier l'effet de la suppression, découverte
d'un défaut plus grave que la longueur. La Divulgation affirmait : « vous
venez de lire **près de deux mille mots** ». La fiction en comptait 1 350
avant la coupe, 1 219 après.

C'était déjà faux. Et c'est l'endroit du site où un chiffre faux coûte le
plus cher : le paragraphe où l'on dit au lecteur qu'on vient de le
manipuler, et comment. Y exagérer d'un tiers fissure exactement ce qu'on
essaie d'établir. Corrigé en « mille deux cents mots ».
...
seulement le faux du vrai, elle crée une dépendance — le vrai d'après parle
du faux d'avant.
